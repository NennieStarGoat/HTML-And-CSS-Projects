...
for (var i = 0; i < btns.length; i++) {
    btns[i].onclick = function (event) {
        ...
        //Automatically closes the modal after 10 seconds
        setTimeout(function () {
...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        ...
        //Email pattern checks for all symbols that would be needed for an email address such as teh @ and . and the text that would come before, between and after.
